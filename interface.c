...
void main() {
    ...
    while(choice!=15) {
        ...
        switch(choice) {
            case 1:
                redimensionerInterface(activeFile);
                break;
            case 2:
                rognerInterface(activeFile);
                break;
            case 3:
                affichageASCIIInterface(activeFile);
                break;
            case 4:
                noirEtBlancInterface(activeFile);
                break;
            case 5:
                rotationInterface(activeFile);
                break;
            case 6:
                luminositeInterface(activeFile);
                break;
            case 7:
                contrasteInterface(activeFile);
                break;
            case 8:
                flouInterface(activeFile);
                break;
            case 9:
                BinariserInterface(activeFile);
                break;
            case 10:
                inverserCouleursInterface(activeFile);
                break;
            case 11:
                symetrieInterface(activeFile);
                break;
            case 12:
                steganographieInterface(activeFile);
                break;
            case 13:
                saveImageInterface(activeFile);
                break;
            case 14:
